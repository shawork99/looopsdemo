...
export class ScatterComponent {
  generateDayWiseTimeSeries(
    ...
    for (var r = 0, o = []; r < t; ) {
      ...
      o.push([e, s]), (e += 864e5), r++
    }
    return o
  }

  scatterMap: Partial<ChartOptions> = {
    series: [
      {
        name: 'SAMPLE A',
        data: [
  ...
  datetimeScatter: Partial<ChartOptions> = {
    series: [
      {
        name: 'TEAM 1',
    ...
    colors: ['#108dff', '#963b68', '#27ebb0', '#f59440'],
    dataLabels: {
      enabled: false,
    },
    grid: {
  ...
  imagesScatter: Partial<ChartOptions> = {
    series: [
      {
        name: 'User',
        data: [
