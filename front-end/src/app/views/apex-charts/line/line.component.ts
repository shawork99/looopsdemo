...
export class LineComponent {
  basicLineChart: Partial<ChartOptions> = {
    series: [
      {
        name: 'Desktops',
  ...
  datableLineChart: Partial<ChartOptions> = {
    series: [
      {
        name: 'High - 2022',
  ...
  zoomableChart: Partial<ChartOptions> = {
    series: [
      {
        name: 'XYZ MOTORS',
        data: [
  ...
  syncingChart: Partial<ChartOptions> = {
    series: [
      {
        data: this.generateDayWiseTimeSeries(
          new Date('11 Jan 2024').getTime(),
          20,
          {
            min: 10,
            max: 60,
  ...
  syncingChart2: Partial<ChartOptions> = {
    series: [
      {
        data: this.generateDayWiseTimeSeries(
          new Date('11 Feb 2024').getTime(),
          20,
          {
            min: 10,
            max: 30,
  ...
  syncingChart3: Partial<ChartOptions> = {
    series: [
      {
        data: this.generateDayWiseTimeSeries(
          new Date('11 March 2024').getTime(),
          20,
          {
            min: 10,
            max: 60,
  ...
  brushlineChart: Partial<ChartOptions> = {
    series: [
      {
        data: data,
      },
  ...
  brushline2Chart: Partial<ChartOptions> = {
    series: [
      {
        data: data,
      },
  ...
  stepLineChart: Partial<ChartOptions> = {
    series: [
      {
  ...
  missingChart: Partial<ChartOptions> = {
    series: [
      {
        name: 'Peter',
    ...
    xaxis: {},
    colors: ['#108dff', '#963b68', '#108dff'],
  }
  realChart: Partial<ChartOptions> = {}
  dashedChart: Partial<ChartOptions> = {
    chart: {
      height: 350,
      type: 'line',
      parentHeightOffset: 0,
    ...
    colors: ['#f59440', '#001b2f', '#108dff'],
    grid: {
      borderColor: '#f1f1f1',
    },
  }
  annotationsLineChart: Partial<ChartOptions> = {
    series: [
      {
