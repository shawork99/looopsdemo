...
export class CandlesticksComponent {
  basicCandle: Partial<ChartOptions> = {
    series: [
      {
        data: [
          {
  ...
  comboCandle: Partial<ChartOptions> = {
    series: [
      {
        data: seriesData,
      },
  ...
  // combo candle
  comboCandle1: Partial<ChartOptions> = {
    series: [
      {
        name: 'volume',
  ...
  // line Chart
  lineCandle: Partial<ChartOptions> = {
    series: [
      {
        name: 'line',
        type: 'line',
